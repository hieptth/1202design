...
const Services = () => {
  ...
  return (
    <div
      id="services"
      ref={sectionRef}
      className={`grid grid-cols-1 lg:grid-cols-2 justify-center gap-5 px-4 lg:px-0 lg:mx-auto animate__animated ${visible ? 'animate__fadeInUp' : 'opacity-0'}`}
      style={{ animationDuration: '0.8s', animationTimingFunction: 'cubic-bezier(.4,0,.2,1)' }}
    >
      <div className="flex flex-col gap-8 rounded-4xl bg-neutral-50 p-9 max-w-[561px] animate__animated animate__fadeInLeft animate__fast">
      ...
      <div className="w-full h-full min-h-[500px] rounded-4xl overflow-hidden max-w-[561px] animate__animated animate__fadeInRight animate__fast">
        <iframe
