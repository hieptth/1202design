  ...
  return (
    <section id="work" className="px-3 sm:px-[10%]">
      <div className="rounded-4xl bg-neutral-50 border-box pt-6 px-4 pb-73.5 md:pt-16 md:pl-16 md:pb-23.5 md:pr-0 relative overflow-hidden">
        <div ref={sectionRef} className="flex flex-col gap-2 sm:gap-3 sm:max-w-7/10 relative z-10">
          <p className={`text-display-sm sm:text-display-lg text-neutral-950 text-balance animate__animated ${visible ? 'animate__zoomInDown' : 'opacity-0'}`}
